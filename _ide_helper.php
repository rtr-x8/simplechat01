...
namespace Illuminate\Support\Facades {
    ...
    class Auth
    {
         ...
         *
         * @return \Shared\Model\UserModel|null
         * @static
         */
         ...
         *
         * @param  mixed  $id
         * @return \Shared\Model\UserModel|false
         * @static
         */
...
namespace LINE\Laravel\Facade {
    ...
    class LINEBot
    {
         ...
         * @static
         */
        public static function sendNarrowcast(
            $messageBuilder,
            $recipientBuilder = null,
            $demographicFilterBuilder = null,
            $max = null,
            $retryKey = null,
            $upToRemainingQuota = false
        ) {
            /** @var \LINE\LINEBot $instance */
            return $instance->sendNarrowcast($messageBuilder, $recipientBuilder, $demographicFilterBuilder, $max,
                $retryKey, $upToRemainingQuota);
        }
         ...
         * @static
         */
        public static function createAudienceGroupForUploadingUserIds(
            $description,
            $audiences = [],
            $isIfaAudience = false,
            ...
            /** @var \LINE\LINEBot $instance */
            return $instance->createAudienceGroupForUploadingUserIds($description, $audiences, $isIfaAudience,
                $uploadDescription);
        }
         ...
         * @static
         */
        public static function createAudienceGroupForUploadingUserIdsByFile(
            $description,
            $filePath,
            $isIfaAudience = false,
            $uploadDescription = null
            ...
            /** @var \LINE\LINEBot $instance */
            return $instance->createAudienceGroupForUploadingUserIdsByFile($description, $filePath, $isIfaAudience,
                $uploadDescription);
        }
         ...
         * @static
         */
        public static function updateAudienceGroupForUploadingUserIds(
            $audienceGroupId,
            $audiences,
            $uploadDescription = null
        ) {
         ...
         * @static
         */
        public static function updateAudienceGroupForUploadingUserIdsByFile(
            $audienceGroupId,
            $filePath,
            $uploadDescription = null
        ) {
            /** @var \LINE\LINEBot $instance */
            return $instance->updateAudienceGroupForUploadingUserIdsByFile($audienceGroupId, $filePath,
                $uploadDescription);
        }
        ...
        public static function getAudiences(
            ...
            /** @var \LINE\LINEBot $instance */
            return $instance->getAudiences($page, $size, $description, $status, $includesExternalPublicGroups,
                $createRoute);
        }
